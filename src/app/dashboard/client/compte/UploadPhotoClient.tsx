...
import { uploadPhotoClient } from "@/app/dashboard/actions-profil";

const GOLD = "#C9A96E";

export default function UploadPhotoClient({ photoUrl, initiale }: { photoUrl?: string; initiale: string }) {
